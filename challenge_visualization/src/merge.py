...
class Imagemerge:
	...
	self.downward_line_sub = rospy.Subscriber('/line/detector_image',Image, self.downward_line_sub_cb)
        ...
        self.master_image = np.zeros((500,500, 3), np.uint8)
	...
	self.master_image[250:500, :250,:] = cv2.resize(converted_img, (250,250))
    ...
    def forward_color_sub_cb(self, img):
        ...
        self.master_image[:250, :250, :] = cv2.resize(converted_img, (250,250)) # downsize the image
	...
	self.master_image[250:500, 250:500,:] = cv2.resize(reconverted_img, (250,250))
